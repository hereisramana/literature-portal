...
export default function Sidebar({
  ...
  return (
    <aside className={`flex h-full flex-col transition-all duration-500 ${collapsed ? "bg-transparent" : "bg-[#2d332e]/10 backdrop-blur-xl lg:backdrop-blur-none lg:bg-white border-r border-white/10 lg:border-none"}`}>
